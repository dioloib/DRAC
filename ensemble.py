...
model_paths = {'IMA':['IMA_UNetpp_DICE_best_model','IMA_UNetpp_DICE_best_model'],\
               'NA':['NA_UNetpp_DICE_best_model','NA_UNetpp_DICE_best_model'],\
                'NE':['NE_UNetpp_DICE_best_model','NE_UNetpp_DICE_best_model'], \
                'NE_nohealth':['NE_nohealth_UNetpp_DICE_best_model','NE_nohealth_UNetpp_DICE_best_model']}
